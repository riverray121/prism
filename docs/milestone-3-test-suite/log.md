...
- [x] Slice 8 — Observability: shell crash detection + health surface (runtime-verified: sidecar kill → banner + `app.log` code 137; force-quit → unclean-exit notice; frontend errors land in `app.log`)
